...
Last updated: `r format(Sys.time(), '%d %B, %Y')` (See [changelog](https://github.com/lindeloev/tests-as-linear/commits/master)).
...
bt = glance(b)
bt$df = bt$df - 1 # https://github.com/tidymodels/broom/issues/273
