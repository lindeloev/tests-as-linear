...
This table to show the underlying linear models of common tests. Formulating all the tests in the same language highlights the many similarities between them. The rest of this document gives the background to this.
...
Use the menu to the left to jump to your favourite section. I hope that others will join in and refine this list as well as add further tests to it. I'm not a statistician and there are likely some inaccuracies or errors here and there.
