...
Concerning the teaching of *non-parametric* tests in intro-courses, I think that we can justify [lying-to-children](https://en.wikipedia.org/wiki/Lie-to-children) and teach non-parametric tests as if they are merely ranked versions of the corresponding parametric tests. Indeed, the Bayesian equivalents implemented in [JASP](https://jasp-stats.org) literally [does just this](https://arxiv.org/abs/1712.06941). For the non-parametric tests considered here, this approach is highly accurate for N > 15.
